...
struct FBO
{
  ...
  void attach (const Texture &tex, GLenum attachment = GL_COLOR_ATTACHMENT0,
  ...
  //could change attachment point or target (e.g. to GL_TEXTURE_CUBE_MAP)
  void attach (const CubeMap &tex, GLenum attachment = GL_COLOR_ATTACHMENT0,
  ...
  void generate () { glGenFramebuffers (1, &mID); }
