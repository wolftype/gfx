...
struct Mouse
{
  ...
  int
    gesture;   // stores major direction of mouse movement (Mouse::Up, Mouse::Down, Mouse::Left, Mouse::Right)
...
struct Interface
{
  ...
  static void OnDraw ()
  {
    ...
    CONTEXT::
      SwapBuffers ();  //<-- Swap Buffers only AFTER all window events call their onFrame() method
  }
