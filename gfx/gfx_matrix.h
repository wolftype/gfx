...
template <class T> std::ostream &operator<<(std::ostream &os, const Vec4<T> &a);
template <class T> std::ostream &operator<<(std::ostream &os, const Mat4<T> &a);
...
public:
  ...
  /// Metric
  double metric() const { return (x * x + y * y); }
...
public:
  ...
  template <class A> Vec3(const A &a) : x(a[0]), y(a[1]), z(a[2]) {}
  ...
  template <class Any> void set(const Any &v) {
    x = v[0];
    y = v[1];
    z = v[2];
  }
...
template <typename T = double> class Mat2 {
public:
  Vec2<T> col[2];
...
template <typename T = double> class Mat3 {
public:
  Vec3<T> col[3];
...
template <typename T = double> class Mat4 {
public:
  Vec4<T> col[4];
  ...
  Mat4(T xx, T xy, T xz, T xw, T yx, T yy, T yz, T yw, T zx, T zy, T zz, T zw,
       T wx, T wy, T wz, T ww) {
  ...
  Mat4 transpose() {
    return Mat4<T>(col[0][0], col[1][0], col[2][0], col[3][0], col[0][1],
                   col[1][1], col[2][1], col[3][1], col[0][2], col[1][2],
                   col[2][2], col[3][2], col[0][3], col[1][3], col[2][3],
                   col[3][3]);
  }

  T get(int a, int b) { return row(a - 1)[b - 1]; }

  T at(int a, int b) {
    return col[b - 1][a - 1]; //(*this)[((a-1)*4)+(b-1)];//row(a-1)[b-1];
  }

  void fill(T *res) const { std::copy(val(), val() + 16, res); }

  template <class B> Mat4 &copy(const B &b) {
    // printf("copy");
    for (int i = 0; i < 16; ++i) {
      (*this)[i] = b[i];
    }
  ...
  Vec4<T> row(int j) const {
    return Vec4<T>(col[0][j], col[1][j], col[2][j], col[3][j]);
  }
  ...
  Mat4 operator*(const Mat4 &B) const {
    Mat4 m;
    for (int i = 0; i < 4; ++i) {
      m.col[i].set(row(0).dot(B.col[i]), row(1).dot(B.col[i]),
                   row(2).dot(B.col[i]), row(3).dot(B.col[i]));
    }
    return m;
  }

  Vec4<T> operator*(const Vec4<T> &v) const {
    return Vec4<T>(row(0).dot(v), row(1).dot(v), row(2).dot(v), row(3).dot(v));
  }
  ...
  Mat4 operator!() {
    Mat4 &m = *this;
    double determinant = m.at(1, 1) * m.at(2, 2) * m.at(3, 3) * m.at(4, 4) +
                         m.at(1, 1) * m.at(2, 3) * m.at(3, 4) * m.at(4, 2) +
                         m.at(1, 1) * m.at(2, 4) * m.at(3, 2) * m.at(4, 3) +
                         m.at(1, 2) * m.at(2, 1) * m.at(3, 4) * m.at(4, 3) +
                         m.at(1, 2) * m.at(2, 3) * m.at(3, 1) * m.at(4, 4) +
                         m.at(1, 2) * m.at(2, 4) * m.at(3, 3) * m.at(4, 1) +
                         m.at(1, 3) * m.at(2, 1) * m.at(3, 2) * m.at(4, 4) +
                         m.at(1, 3) * m.at(2, 2) * m.at(3, 4) * m.at(4, 1) +
                         m.at(1, 3) * m.at(2, 4) * m.at(3, 1) * m.at(4, 2) +
                         m.at(1, 4) * m.at(2, 1) * m.at(3, 3) * m.at(4, 2) +
                         m.at(1, 4) * m.at(2, 2) * m.at(3, 1) * m.at(4, 3) +
                         m.at(1, 4) * m.at(2, 3) * m.at(3, 2) * m.at(4, 1) -
                         m.at(1, 1) * m.at(2, 2) * m.at(3, 4) * m.at(4, 3) -
                         m.at(1, 1) * m.at(2, 3) * m.at(3, 2) * m.at(4, 4) -
                         m.at(1, 1) * m.at(2, 4) * m.at(3, 3) * m.at(4, 2) -
                         m.at(1, 2) * m.at(2, 1) * m.at(3, 3) * m.at(4, 4) -
                         m.at(1, 2) * m.at(2, 3) * m.at(3, 4) * m.at(4, 1) -
                         m.at(1, 2) * m.at(2, 4) * m.at(3, 1) * m.at(4, 3) -
                         m.at(1, 3) * m.at(2, 1) * m.at(3, 4) * m.at(4, 2) -
                         m.at(1, 3) * m.at(2, 2) * m.at(3, 1) * m.at(4, 4) -
                         m.at(1, 3) * m.at(2, 4) * m.at(3, 2) * m.at(4, 1) -
                         m.at(1, 4) * m.at(2, 1) * m.at(3, 2) * m.at(4, 3) -
                         m.at(1, 4) * m.at(2, 2) * m.at(3, 3) * m.at(4, 1) -
                         m.at(1, 4) * m.at(2, 3) * m.at(3, 1) * m.at(4, 2);

    return Mat4(m.at(2, 2) * m.at(3, 3) * m.at(4, 4) +
                    m.at(2, 3) * m.at(3, 4) * m.at(4, 2) +
                    m.at(2, 4) * m.at(3, 2) * m.at(4, 3) -
                    m.at(2, 2) * m.at(3, 4) * m.at(4, 3) -
                    m.at(2, 3) * m.at(3, 2) * m.at(4, 4) -
                    m.at(2, 4) * m.at(3, 3) * m.at(4, 2),

                m.at(2, 1) * m.at(3, 4) * m.at(4, 3) +
                    m.at(2, 3) * m.at(3, 1) * m.at(4, 4) +
                    m.at(2, 4) * m.at(3, 3) * m.at(4, 1) -
                    m.at(2, 1) * m.at(3, 3) * m.at(4, 4) -
                    m.at(2, 3) * m.at(3, 4) * m.at(4, 1) -
                    m.at(2, 4) * m.at(3, 1) * m.at(4, 3),

                m.at(2, 1) * m.at(3, 2) * m.at(4, 4) +
                    m.at(2, 2) * m.at(3, 4) * m.at(4, 1) +
                    m.at(2, 4) * m.at(3, 1) * m.at(4, 2) -
                    m.at(2, 1) * m.at(3, 4) * m.at(4, 2) -
                    m.at(2, 2) * m.at(3, 1) * m.at(4, 4) -
                    m.at(2, 4) * m.at(3, 2) * m.at(4, 1),

                m.at(2, 1) * m.at(3, 3) * m.at(4, 2) +
                    m.at(2, 2) * m.at(3, 1) * m.at(4, 3) +
                    m.at(2, 3) * m.at(3, 2) * m.at(4, 1) -
                    m.at(2, 1) * m.at(3, 2) * m.at(4, 3) -
                    m.at(2, 2) * m.at(3, 3) * m.at(4, 1) -
                    m.at(2, 3) * m.at(3, 1) * m.at(4, 2),
                ///
                m.at(1, 2) * m.at(3, 4) * m.at(4, 3) +
                    m.at(1, 3) * m.at(3, 2) * m.at(4, 4) +
                    m.at(1, 4) * m.at(3, 3) * m.at(4, 2) -
                    m.at(1, 2) * m.at(3, 3) * m.at(4, 4) -
                    m.at(1, 3) * m.at(3, 4) * m.at(4, 2) -
                    m.at(1, 4) * m.at(3, 2) * m.at(4, 3),

                m.at(1, 1) * m.at(3, 3) * m.at(4, 4) +
                    m.at(1, 3) * m.at(3, 4) * m.at(4, 1) +
                    m.at(1, 4) * m.at(3, 1) * m.at(4, 3) -
                    m.at(1, 1) * m.at(3, 4) * m.at(4, 3) -
                    m.at(1, 3) * m.at(3, 1) * m.at(4, 4) -
                    m.at(1, 4) * m.at(3, 3) * m.at(4, 1),

                m.at(1, 1) * m.at(3, 4) * m.at(4, 2) +
                    m.at(1, 2) * m.at(3, 1) * m.at(4, 4) +
                    m.at(1, 4) * m.at(3, 2) * m.at(4, 1) -
                    m.at(1, 1) * m.at(3, 2) * m.at(4, 4) -
                    m.at(1, 2) * m.at(3, 4) * m.at(4, 1) -
                    m.at(1, 4) * m.at(3, 1) * m.at(4, 2),

                m.at(1, 1) * m.at(3, 2) * m.at(4, 3) +
                    m.at(1, 2) * m.at(3, 3) * m.at(4, 1) +
                    m.at(1, 3) * m.at(3, 1) * m.at(4, 2) -
                    m.at(1, 1) * m.at(3, 3) * m.at(4, 2) -
                    m.at(1, 2) * m.at(3, 1) * m.at(4, 3) -
                    m.at(1, 3) * m.at(3, 2) * m.at(4, 1),
                ///
                m.at(1, 2) * m.at(2, 3) * m.at(4, 4) +
                    m.at(1, 3) * m.at(2, 4) * m.at(4, 2) +
                    m.at(1, 4) * m.at(2, 2) * m.at(4, 3) -
                    m.at(1, 2) * m.at(2, 4) * m.at(4, 3) -
                    m.at(1, 3) * m.at(2, 2) * m.at(4, 4) -
                    m.at(1, 4) * m.at(2, 3) * m.at(4, 2),

                m.at(1, 1) * m.at(2, 4) * m.at(4, 3) +
                    m.at(1, 3) * m.at(2, 1) * m.at(4, 4) +
                    m.at(1, 4) * m.at(2, 3) * m.at(4, 1) -
                    m.at(1, 1) * m.at(2, 3) * m.at(4, 4) -
                    m.at(1, 3) * m.at(2, 4) * m.at(4, 1) -
                    m.at(1, 4) * m.at(2, 1) * m.at(4, 3),

                m.at(1, 1) * m.at(2, 2) * m.at(4, 4) +
                    m.at(1, 2) * m.at(2, 4) * m.at(4, 1) +
                    m.at(1, 4) * m.at(2, 1) * m.at(4, 2) -
                    m.at(1, 1) * m.at(2, 4) * m.at(4, 2) -
                    m.at(1, 2) * m.at(2, 1) * m.at(4, 4) -
                    m.at(1, 4) * m.at(2, 2) * m.at(4, 1),

                m.at(1, 1) * m.at(2, 3) * m.at(4, 2) +
                    m.at(1, 2) * m.at(2, 1) * m.at(4, 3) +
                    m.at(1, 3) * m.at(2, 2) * m.at(4, 1) -
                    m.at(1, 1) * m.at(2, 2) * m.at(4, 3) -
                    m.at(1, 2) * m.at(2, 3) * m.at(4, 1) -
                    m.at(1, 3) * m.at(2, 1) * m.at(4, 2),
                ///
                m.at(1, 2) * m.at(2, 4) * m.at(3, 3) +
                    m.at(1, 3) * m.at(2, 2) * m.at(3, 4) +
                    m.at(1, 4) * m.at(2, 3) * m.at(3, 2) -
                    m.at(1, 2) * m.at(2, 3) * m.at(3, 4) -
                    m.at(1, 3) * m.at(2, 4) * m.at(3, 2) -
                    m.at(1, 4) * m.at(2, 2) * m.at(3, 3),

                m.at(1, 1) * m.at(2, 3) * m.at(3, 4) +
                    m.at(1, 3) * m.at(2, 4) * m.at(3, 1) +
                    m.at(1, 4) * m.at(2, 1) * m.at(3, 3) -
                    m.at(1, 1) * m.at(2, 4) * m.at(3, 3) -
                    m.at(1, 3) * m.at(2, 1) * m.at(3, 4) -
                    m.at(1, 4) * m.at(2, 3) * m.at(3, 1),

                m.at(1, 1) * m.at(2, 4) * m.at(3, 2) +
                    m.at(1, 2) * m.at(2, 1) * m.at(3, 4) +
                    m.at(1, 4) * m.at(2, 2) * m.at(3, 1) -
                    m.at(1, 1) * m.at(2, 2) * m.at(3, 4) -
                    m.at(1, 2) * m.at(2, 4) * m.at(3, 1) -
                    m.at(1, 4) * m.at(2, 1) * m.at(3, 2),

                m.at(1, 1) * m.at(2, 2) * m.at(3, 3) +
                    m.at(1, 2) * m.at(2, 3) * m.at(3, 1) +
                    m.at(1, 3) * m.at(2, 1) * m.at(3, 2) -
                    m.at(1, 1) * m.at(2, 3) * m.at(3, 2) -
                    m.at(1, 2) * m.at(2, 1) * m.at(3, 3) -
                    m.at(1, 3) * m.at(2, 2) * m.at(3, 1)

                    ) *
           (1. / determinant);
  }

  template <class S> friend ostream &operator<<(ostream &, const Mat4<S> &);
};

template <class T> inline ostream &operator<<(ostream &os, const Mat4<T> &m) {
...
template <typename T = double> class Mat5 {
public:
  Vec5<T> col[5];
...
public:
  ...
  Quat(double _w = 1.0, double _x = 0.0, double _y = 0.0, double _z = 0.0)
      : w(_w), x(_x), y(_y), z(_z) {}
  Quat(double rad, Vec3<> v) {
    Vec3<> t = v.unit() * sin(rad);
    w = cos(rad);
    x = t.x;
    y = t.y;
    z = t.z;
  ...
  template <class T> Quat &set(const T &t) {
    w = t[0];
    x = t[1];
    y = t[2];
    z = t[3];
  ...
  template <class T> Quat &set(const T &a, const T &b, const T &c, const T &d) {
    w = a;
    x = b;
    y = c;
    z = d;
  ...
  static Vec3<> spin(Vec3<> v, Quat q) {
    return Quat(q.unit() * Quat(v) * (~(q.unit()))).vec();
  }
  ...
  Mat4<> mat4() {
    ...
    return Mat4<>(1.0 - (yy + zz), xy - wz, xz + wy, 0.0, xy + wz,
                  1.0 - (xx + zz), yz - wx, 0.0, xz - wy, yz + wx,
                  1.0 - (xx + yy), 0.0, 0, 0, 0, 1);
  }
  ...
  static Quat Rotor(const Vec3<> &v1, const Vec3<> &v2) {
    ...
    // n.unit()();  // normalize because the cross product can get slightly
    // denormalized
...
// template <typename T>
// inline Vec3<T> operator * (const Vec3& v) const { return Quat ( dot(v), x *
// v.y - y * v.x, y * v.z - z * v.y, x * v.z - z * v.x); }
...
struct Pose {
  ...
  Pose(float x, float y, float z)
      : mPos(x, y, z), mQuat(1, 0, 0, 0) {} // orient(); }
  ...
  Pose &pos(float x, float y, float z) {
    mPos.set(x, y, z);
    return *this;
  }
  ...
  template <class P, class Q> Pose &set(const P &t, const Q &q) {
  ...
  Pose &reset(float x = 0.0, float y = 0.0, float z = 0.0,
              Quat q = Quat(1, 0, 0, 0)) {
    mPos.set(x, y, z);
  ...
  void print() { cout << mPos << mQuat << endl; }
};
