 ...
 *       Filename:  glv_gui.h
 *
 *    Description:  gui wrapper around glv
 *
 *        Version:  1.0
 *        Created:  10/31/2014 17:32:37
 *       Revision:  none
 *       Compiler:  gcc
 *
...
#include "GLV/glv.h"
#include "util/gfx_std_types.h"

using namespace std;
using namespace gfx::util;
    ...
    class Gui : public Table {
        ...
        public:
          ...
          Gui& operator () (T& val, string nm = "", float min = 0, float max = 1){
              ...
              switch ( gfx::util::Types[ typeid(T).name() ] ){
                  case gfx::util::BOOLEAN:
