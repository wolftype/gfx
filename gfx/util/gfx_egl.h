...
//                EGLConfig& operator ()() { return config[mIdx]; }
            ...
            void choose(){
                ...
                State = eglChooseConfig( 
                          *display, &attribs[0], 
                          &config[mIdx], 1, &numConfig);  
        ...
        struct Window {
          ...
          ~Window() {
              ...
              State = eglDestroySurface( 
                      display.display, surface.surface ); 
              Error ("Destroy Surface");
              State = eglDestroyContext( 
