  ...
  switch (err)
    {
      case GL_INVALID_ENUM:
        printf ("%s:\n %s\n", msg, "An unacceptable value is specified for an "
      ...
      case GL_INVALID_VALUE:
        printf ("%s:\n %s\n", msg, "A numeric argument is out of range. The "
      ...
      case GL_INVALID_OPERATION:
        printf ("%s:\n %s\n", msg, "The specified operation is not allowed in "
      ...
      case GL_STACK_UNDERFLOW:
        printf ("%s:\n %s\n", msg, "This command would cause a stack "
...
inline void clear (GLbitfield a)
{
  glClear (a);
}
...
inline void enable (Ability a)
{
  glEnable (a);
}
inline void disable (Ability a)
{
  glDisable (a);
}
inline void ability (Ability a, bool v)
{
  v ? enable (a) : disable (a);
}
inline void blending (bool b)
{
  ability (BLEND, b);
}
...
inline void global (float *r)
{
  glLightModelfv (GL_LIGHT_MODEL_AMBIENT, r);
}
...
inline void specular (float r = 1.0, float g = 1.0, float b = 1.0,
                      float a = 1.0, GLenum lightnum = GL_LIGHT0)
{
